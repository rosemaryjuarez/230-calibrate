...
compute_highflowmetrics(m=sager$model,o=sager$obs, month=sager$month, day=sager$day, year=sager$year, wy=sager$wy, high_flow_months = c(4:5))
```
...
# steps fro split and sample calibration 
source("R/nse.R")
source("R/relerr.R")
